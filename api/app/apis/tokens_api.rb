class TokensAPI < Grape::API
  ...
  resource :tokens do
    ...
    get 'linkedin' do
      ...
      profile_url = "https://api.linkedin.com/v1/people/~:(id,email-address,first-name,last-name,headline,picture-url,picture-urls::(original),public-profile-url,site-standard-profile-request,specialties,industry,location,positions)"
